...
const frameProps = {   summaries: [{ coordinates: [{ theaterCount: 4, rank: 18, grossWeekly: 327616, title: "Ex Machina" },
    ...
    { coordinates: [{ theaterCount: 10, rank: 24, grossWeekly: 240160, title: "Far from the Madding Crowd" },
        ...
        { theaterCount: 18, rank: 60, grossWeekly: 17292, title: "Far from the Madding Crowd" }], title: "Far from the Madding Crowd" },
    { coordinates: [{ theaterCount: 3366, rank: 3, grossWeekly: 16660516, title: "The Longest Ride" },
        ...
        { theaterCount: 9, rank: 67, grossWeekly: 6872, title: "The Longest Ride" }], title: "The Longest Ride" }],
  size: [700,400],
  ...
  yExtent: [0],
  xExtent: [0],
  summaryStyle: function(e){return{fill:"none",stroke:colors[e.parentSummary.title],strokeWidth:.5}},
  pointStyle: d => {
    return {
      r: 2,
