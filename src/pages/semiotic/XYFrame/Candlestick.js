...
const colors = ["#365350", "#9fd0cb", "#E0488B", "#7a255d"]
        
const frameProps = {   points: [{ date: "09/14/2018", open: 368, high: 371, low: 363, close: 364.56 },
  ...
  yAccessor: function(e){return[e.open,e.high,e.low,e.close]},
  pointStyle: function(e,t,n){return{fill:colors[n]}},
  title: <text textAnchor="middle">
      Netflix Stock Price: <tspan fill={"#9fd0cb"}>Close &gt; Open</tspan> vs.{" "}
      <tspan fill={"#E0488B"}>Close &lt; Open</tspan>
    </text>,
  axes: [{ orient: "left" },
    { orient: "bottom", tickFormat: function(e){return e.getMonth()+"/"+e.getDate()} }],
    ...
    return (
      <g>
        ...
        <rect
          ...
          fill={d.open > d.close ? "#E0488B" : "#9fd0cb"}
        />
      </g>
    )
  },
